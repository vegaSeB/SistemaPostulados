...
#tit {
    ...
    <body class="ini">
        ...
        <div class="container pt-lg-3">
            <form class="row g-2 pb-lg-3 pt-lg-3" action="http://localhost:8080/SistemaPostulados/ServletAdmin" method="get" id="pr">
                ...
                <div class="col">
                    <button type="submit" class="btn btn-success">Buscar Postulado</button>
                </div>
            </form>
        </div>
